...
COLOR_PROFILE_JSON = """{"backgroundGradientRotationAngle":37.1,"serverRowBackgroundColor":"#3D210067","subsHeaderColor":"#8B2020FF","profileWebPageIconColor":"#FFB0B0FF","selectedServerRowColor":"#622B2BB5","disclosureSubHeaderTextColor":"#E2C1C1FF","buttonTextColor":"#FFFFFFFF","buttonTimerColor":"#FFFFFFFF","subscriptionInfoBackgroundColor":"#3C2100FF","backgroundColors":["#7D2A2AFF","#BA5757FF","#FF77777F"],"disclosureHeaderTextColor":"#FFFFFFFF","backgroundGradientColorIntensity":1,"additionalOptionsButtonColor":"#FFFFFFFF","buttonImageType":"light","serverRowSubTitleTextColor":"#E2C1C1FF","supportIconColor":"#FFFFFFFF","topBarButtonsColor":"#FFFFFFFF","subscriptionTrafficBackgroundColor":"#A73E3EFF","subHeaderButtonColor":"#FFFFFFFF","buttonColor":"#FF7777FF","powerIconColor":"#7D2A2AFF","subscriptionInfoTextColor":"#FFFFFFFF","serverRowTitleTextColor":"#FFFFFFFF","backgroundImageType":"system","elipseColors":["#B46000FF","#FF72CFE0","#00DDFFFF"],"serverRowChevronColor":"#FFFFFFFF"}"""
