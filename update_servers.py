...
COLOR_PROFILE_JSON = """{"backgroundGradientRotationAngle":0,"serverRowBackgroundColor":"#1A1A1AFF","subsHeaderColor":"#FFFFFFFF","profileWebPageIconColor":"#FFFFFFFF","selectedServerRowColor":"#2A2A2AFF","disclosureSubHeaderTextColor":"#AAAAAAFF","buttonTextColor":"#FFFFFFFF","buttonTimerColor":"#FFFFFFFF","subscriptionInfoBackgroundColor":"#1A1A1AFF","backgroundColors":["#0D0D0DFF","#1A1A1AFF","#2A2A2AFF"],"disclosureHeaderTextColor":"#FFFFFFFF","backgroundGradientColorIntensity":1,"additionalOptionsButtonColor":"#FFFFFFFF","buttonImageType":"dark","serverRowSubTitleTextColor":"#AAAAAAFF","supportIconColor":"#FFFFFFFF","topBarButtonsColor":"#FFFFFFFF","subscriptionTrafficBackgroundColor":"#2A2A2AFF","subHeaderButtonColor":"#FFFFFFFF","buttonColor":"#FFFFFFFF","powerIconColor":"#FFFFFFFF","subscriptionInfoTextColor":"#FFFFFFFF","serverRowTitleTextColor":"#FFFFFFFF","backgroundImageType":"dark","elipseColors":["#333333FF","#444444FF","#555555FF"],"serverRowChevronColor":"#FFFFFFFF"}"""
