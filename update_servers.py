...
COLOR_PROFILE_JSON = """{"backgroundGradientRotationAngle":45,"serverRowChevronColor":"#E8D5FFFF","buttonImageType":"light","buttonTimerColor":"#2D1B4EFF","subscriptionTrafficBackgroundColor":"#1F0D3AFF","subscriptionInfoBackgroundColor":"#2E1654FF","serverRowTitleTextColor":"#E8D5FFFF","serverRowBackgroundColor":"#1A0A30FF","powerIconColor":"#C084FCCA","supportIconColor":"#F0E6FFFF","profileWebPageIconColor":"#F5FFF9FF","selectedServerRowColor":"#3D1C70FF","disclosureHeaderTextColor":"#E8D5FFFF","subsHeaderColor":"#2E1654FF","elipseColors":["#C084FCFF","#A855F7FF","#7C3AEDFF"],"subscriptionInfoTextColor":"#D4BFFFFF","buttonColor":"#A855F7FF","serverRowSubTitleTextColor":"#B89BE0FF","topBarButtonsColor":"#FFFFFFD8","settingsControlsTintColor":"#A855F7FF","backgroundGradientColorIntensity":1,"disclosureSubHeaderTextColor":"#C9A9FFFF","additionalOptionsButtonColor":"#C084FC99","backgroundImageType":"light","backgroundColors":["#1A0A30FF","#1A0A30FF","#2E1654FF","#4B2080FF","#6D28D9FF"],"subHeaderButtonColor":"#C084FCFF","buttonTextColor":"#FFFFFFFF"}"""
