...
COLOR_PROFILE_JSON = """{"backgroundGradientRotationAngle":37.1,"serverRowBackgroundColor":"#00264DFF","subsHeaderColor":"#FFFFFFFF","profileWebPageIconColor":"#3399FFFF","selectedServerRowColor":"#003D73B5","disclosureSubHeaderTextColor":"#FFFFFFFF","buttonTextColor":"#FFFFFFFF","buttonTimerColor":"#FFFFFFFF","subscriptionInfoBackgroundColor":"#00264DFF","backgroundColors":["#001A33FF","#003366FF","#004C99FF"],"disclosureHeaderTextColor":"#FFFFFFFF","backgroundGradientColorIntensity":1,"additionalOptionsButtonColor":"#FFFFFFFF","buttonImageType":"dark","serverRowSubTitleTextColor":"#FFFFFFFF","supportIconColor":"#FFFFFFFF","topBarButtonsColor":"#3399FFFF","subscriptionTrafficBackgroundColor":"#003D73FF","subHeaderButtonColor":"#FFFFFFFF","buttonColor":"#004C99FF","powerIconColor":"#3399FFFF","subscriptionInfoTextColor":"#FFFFFFFF","serverRowTitleTextColor":"#FFFFFFFF","backgroundImageType":"system","elipseColors":["#0055AAFF","#0077DDFF","#3399FFFF"],"serverRowChevronColor":"#FFFFFFFF"}"""
