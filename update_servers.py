...
COLOR_PROFILE_JSON = """{"backgroundGradientRotationAngle":37.1,"serverRowBackgroundColor":"#00264DFF","subsHeaderColor":"#FFFFFFFF","profileWebPageIconColor":"#FFFFFFFF","selectedServerRowColor":"#003366B5","disclosureSubHeaderTextColor":"#B0C4DEFF","buttonTextColor":"#FFFFFFFF","buttonTimerColor":"#FFFFFFFF","subscriptionInfoBackgroundColor":"#00264DFF","backgroundColors":["#001A33FF","#003366FF","#004C99FF"],"disclosureHeaderTextColor":"#FFFFFFFF","backgroundGradientColorIntensity":1,"additionalOptionsButtonColor":"#FFFFFFFF","buttonImageType":"light","serverRowSubTitleTextColor":"#B0C4DEFF","supportIconColor":"#FFFFFFFF","topBarButtonsColor":"#FFFFFFFF","subscriptionTrafficBackgroundColor":"#003366FF","subHeaderButtonColor":"#FFFFFFFF","buttonColor":"#66B2FFFF","powerIconColor":"#003366FF","subscriptionInfoTextColor":"#FFFFFFFF","serverRowTitleTextColor":"#FFFFFFFF","backgroundImageType":"system","elipseColors":["#0066CCFF","#3399FFFF","#66B2FFFF"],"serverRowChevronColor":"#FFFFFFFF"}"""
